...
def Gurobi_Algorithm(max_seconds_allowed_for_calculation=0,directory_containing_Node_Specifications_file="",directory__containing_Vehicle_Specifications_file="",directory_containing_Distance_Matrices_file="",directory_details_for_saving=""):
    
    os.mkdir(directory_details_for_saving+"Gurobi Solution")
    directory_to_save_Gurobi_solution=directory_details_for_saving+"Gurobi Solution/"
    ...
    if max_seconds_allowed_for_calculation>0:
        ...
        textfile.write("\t The Objective Value is "+str(objec_val)+" obtained within "+str(mdl.Runtime)+" seconds possibly with some Relative Gap... \n \n \n")
    else:
