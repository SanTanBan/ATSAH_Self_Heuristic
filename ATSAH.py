...
def ATS_Algorithm_Heuristic(directory_details_for_saving="",directory_containing_Vehicle_Types_file="",directory_containing_Node_Locations_file="",directory_containing_Distance_Matrix_file=""):
    ...
    def SubArray_Transplant_Allowing_Operations(Node_Sequence):
        ...
        if randint(-1,1):   # Way 1 is Taking a Random Length of Consecutive Elements
        ...
        # Performing Operations on the Node_Sequence without the Sub-Array Elements
        if randint(-1,1):
            ...
            for each_Edge_Graph in set_of_Mother_Edge_Graphs:
                ...
                if length_of_Daughter_array>=3:
                    ...
                    if evaluation_process==12:  # Randomly Accepting 1 or 2 Daughter Edges
                        ...
                        minimum_Distributed_Cost=999999999
                        for i in array_containing_all_Daughter_Edges:
                    ...
                    elif evaluation_process==4: # Accepting the Minimum Distributed Cost; Here Cost is Variable_Cost/Cumulative_Number_of_Nodes + Fixed_Cost/Number_of_Nodes of any Edge
                        minimum_Distributed_Cost=999999999
                        for i in array_containing_all_Daughter_Edges:
                            length=i[1]-i[0]
                            cumulative_length=length*(length+1)/2
                    ...
                    elif evaluation_process==8: # Accepting the Minimum Cost wrt Cumulative Number of Nodes of the Edge or second minimum
                        minimum_Distributed_Cost=999999999
                        potential_mother_edge=array_containing_all_Daughter_Edges[-1]
                        second_potential_mother_edge=array_containing_all_Daughter_Edges[-2]
                        for i in array_containing_all_Daughter_Edges:
                    ...
                    elif evaluation_process==9: # Accepting the Minimum Distributed Cost; Here Cost is Variable_Cost/Cumulative_Number_of_Nodes + Fixed_Cost/Number_of_Nodes of any Edge, or the second Minimum
                        minimum_Distributed_Cost=999999999
                        potential_mother_edge=array_containing_all_Daughter_Edges[-1]
                        second_potential_mother_edge=array_containing_all_Daughter_Edges[-2]
                        for i in array_containing_all_Daughter_Edges:
